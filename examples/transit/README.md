...
## Boarding and alighting penalties

`TransitAssignmentOptions` also carries `boarding_penalty` and
`alighting_penalty` (default `0.0`), plain perceived costs in the same
time units as the segment times:
