//! Example: 4-step model on a small in-memory network with multi-class assignment.
//!
//! Identical to `simple_network` except the config includes two user classes:
//! cars (PCU=1.0) and trucks (PCU=2.5). Demand split: 90%/10%.
//!
//! ```text
//!        Zone 1 (residential)
//!          |
...
fn main() {
    ...
    // multi-class: 90% car (PCU=1.0) + 10% truck (PCU=2.5)
